    ...
    openedFiles(openedFiles_)
{
    ...
    StaticBoxSizer2->Add(FlexGridSizer11, 1, wxEXPAND, 0);
    ...
    FlexGridSizer4->Add(UserReportEdit, 1, wxEXPAND, 5);
    ...
    FlexGridSizer2->Add(mailEdit, 1, wxEXPAND, 5);
    ...
    FlexGridSizer7->Add(StaticText6, 1, wxEXPAND, 5);
    ...
    FlexGridSizer10->Add(StaticText7, 1, wxEXPAND, 5);
    ...
    FlexGridSizer10->Add(openedFilesEdit, 1, wxEXPAND, 5);
