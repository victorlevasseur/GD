...
ImportImage::ImportImage(wxWindow* parent, int pageSelected)
{
	...
	FlexGridSizer4->Add(FileGIFEdit, 1, wxEXPAND, 5);
	...
	FlexGridSizer3->Add(StaticBoxSizer1, 1, wxEXPAND, 5);
	...
	FlexGridSizer9->Add(StaticText9, 1, wxEXPAND, 5);
	...
	FlexGridSizer10->Add(fileRPGEdit, 1, wxEXPAND, 5);
	...
	FlexGridSizer14->Add(fileSSEdit, 1, wxEXPAND, 5);
	...
	FlexGridSizer15->Add(StaticBoxSizer4, 1, wxEXPAND, 5);
	...
	StaticBoxSizer5->Add(FlexGridSizer20, 1, wxEXPAND, 0);
	...
	FlexGridSizer13->Add(FlexGridSizer15, 1, wxEXPAND, 0);
	...
	StaticBoxSizer7->Add(FlexGridSizer24, 1, wxEXPAND, 0);
	FlexGridSizer13->Add(StaticBoxSizer7, 1, wxEXPAND, 5);
	...
	FlexGridSizer23->Add(decomposeSSEdit, 1, wxEXPAND, 5);
	...
	FlexGridSizer2->Add(Notebook1, 1, wxEXPAND, 5);
	FlexGridSizer1->Add(FlexGridSizer2, 1, wxEXPAND, 0);
	StaticLine2 = new wxStaticLine(this, ID_STATICLINE2, wxDefaultPosition, wxSize(10,-1), wxLI_HORIZONTAL, _T("ID_STATICLINE2"));
	FlexGridSizer1->Add(StaticLine2, 1, wxEXPAND, 0);
