    ...
    currentPlatform(&project.GetCurrentPlatform())
{
	...
	FlexGridSizer6->Add(platformList, 1, wxEXPAND, 5);
	...
	FlexGridSizer1->Add(FlexGridSizer6, 1, wxEXPAND, 0);
	...
	FlexGridSizer2->Add(ExtensionsList, 1, wxEXPAND, 5);
	...
	FlexGridSizer7->Add(infoEdit, 1, wxEXPAND, 5);
	FlexGridSizer5->Add(FlexGridSizer7, 1, wxEXPAND, 0);
	...
	FlexGridSizer5->Add(FlexGridSizer8, 1, wxEXPAND, 0);
	...
	FlexGridSizer5->Add(FlexGridSizer9, 1, wxEXPAND, 0);
	...
	FlexGridSizer5->Add(FlexGridSizer10, 1, wxEXPAND, 0);
	StaticBoxSizer2->Add(FlexGridSizer5, 1, wxEXPAND, 0);
	FlexGridSizer3->Add(StaticBoxSizer2, 1, wxEXPAND, 5);
	FlexGridSizer3->Add(-1,-1,1, wxEXPAND, 0);
	...
	FlexGridSizer3->Add(StaticBoxSizer3, 1, wxEXPAND, 5);
	FlexGridSizer12->Add(FlexGridSizer3, 1, wxEXPAND, 0);
	FlexGridSizer1->Add(FlexGridSizer12, 1, wxEXPAND, 0);
	...
	FlexGridSizer4->Add(StaticText2, 1, wxEXPAND, 10);
