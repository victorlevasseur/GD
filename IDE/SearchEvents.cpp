...
events(events_)
{
	...
	searchEdit->SetFocus();
	FlexGridSizer4->Add(searchEdit, 1, wxEXPAND, 5);
	...
	FlexGridSizer2->Add(FlexGridSizer9, 1, wxEXPAND, 0);
	...
	StaticBoxSizer2->Add(FlexGridSizer7, 1, wxEXPAND, 5);
	FlexGridSizer6->Add(StaticBoxSizer2, 1, wxEXPAND, 5);
	...
	FlexGridSizer6->Add(StaticBoxSizer1, 1, wxEXPAND, 5);
	FlexGridSizer2->Add(FlexGridSizer6, 1, wxEXPAND, 0);
	...
	FlexGridSizer8->Add(FlexGridSizer18, 1, wxEXPAND, 0);
	...
	FlexGridSizer11->Add(searchToReplaceEdit, 1, wxEXPAND, 5);
	BoxSizer1->Add(FlexGridSizer11, 1, wxEXPAND, 0);
	...
	FlexGridSizer3->Add(replaceEdit, 1, wxEXPAND, 5);
	BoxSizer1->Add(FlexGridSizer3, 1, wxEXPAND, 0);
	FlexGridSizer10->Add(BoxSizer1, 1, wxEXPAND, 0);
	...
	StaticBoxSizer3->Add(FlexGridSizer13, 1, wxEXPAND, 5);
	FlexGridSizer12->Add(StaticBoxSizer3, 1, wxEXPAND, 5);
	...
	FlexGridSizer14->Add(FlexGridSizer17, 1, wxEXPAND, 0);
	StaticBoxSizer4->Add(FlexGridSizer14, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	FlexGridSizer12->Add(StaticBoxSizer4, 1, wxEXPAND, 5);
	FlexGridSizer10->Add(FlexGridSizer12, 1, wxEXPAND, 0);
	...
	FlexGridSizer16->Add(FlexGridSizer19, 1, wxEXPAND, 0);
	...
	FlexGridSizer10->Add(FlexGridSizer16, 1, wxEXPAND, 0);
