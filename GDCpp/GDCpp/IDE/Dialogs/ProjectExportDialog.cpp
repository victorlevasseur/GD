    ...
    gameToCompile(gameToCompile_)
{
    ...
    FlexGridSizer10->Add(AvancementGauge, 1, wxEXPAND, 5);
    ...
    FlexGridSizer7->Add(FlexGridSizer10, 1, wxEXPAND, 0);
    ...
    FlexGridSizer8->Add(dirEdit, 1, wxEXPAND, 5);
    ...
    FlexGridSizer7->Add(StaticBoxSizer1, 1, wxEXPAND, 5);
