...
Credits::Credits(wxWindow* parent)
{
	...
	FlexGridSizer3->Add(StaticText1, 1, wxEXPAND, 0);
	...
	FlexGridSizer10->Add(FlexGridSizer7, 1, wxEXPAND, 0);
	...
	FlexGridSizer11->Add(TextCtrl1, 1, wxEXPAND, 5);
	...
	FlexGridSizer6->Add(HtmlWindow1, 1, wxEXPAND, 5);
	...
	FlexGridSizer12->Add(GridSizer2, 1, wxEXPAND, 0);
	...
	FlexGridSizer12->Add(GridSizer1, 1, wxEXPAND, 0);
	...
	FlexGridSizer12->Add(GridSizer3, 1, wxEXPAND, 0);
