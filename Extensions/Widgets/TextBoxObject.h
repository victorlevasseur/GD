...
namespace simplgui { class TextBox; }
class GDResourcesGetter;
...
public :
    ...
    TextBoxObject(gd::String name_);
    TextBoxObject(const TextBoxObject &other);
    virtual ~TextBoxObject();
    virtual gd::Object * Clone() const { return new TextBoxObject(*this); }
    TextBoxObject& operator=(const TextBoxObject &other);
