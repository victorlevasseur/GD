...
b(b_)
{
	...
	FlexGridSizer2->Add(offsetXEdit, 1, wxEXPAND, 5);
	...
	FlexGridSizer2->Add(offsetYEdit, 1, wxEXPAND, 5);
	...
	FlexGridSizer2->Add(widthEdit, 1, wxEXPAND, 5);
	...
	FlexGridSizer2->Add(heightEdit, 1, wxEXPAND, 5);
