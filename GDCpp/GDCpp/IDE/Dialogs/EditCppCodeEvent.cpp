    ...
    scene(scene_)
{
	...
	FlexGridSizer2->Add(FlexGridSizer17, 1, wxEXPAND, 0);
	...
	FlexGridSizer13->Add(objectPassedAsParameterEdit, 1, wxEXPAND, 5);
	...
	FlexGridSizer8->Add(FlexGridSizer13, 1, wxEXPAND, 0);
	FlexGridSizer7->Add(FlexGridSizer8, 1, wxEXPAND, 0);
	StaticBoxSizer2->Add(FlexGridSizer7, 1, wxEXPAND, 0);
	FlexGridSizer12->Add(StaticBoxSizer2, 1, wxEXPAND, 5);
	...
	FlexGridSizer14->Add(dependenciesList, 1, wxEXPAND, 0);
	StaticBoxSizer4->Add(FlexGridSizer14, 1, wxEXPAND, 0);
	...
	FlexGridSizer15->Add(displayedNameEdit, 1, wxEXPAND, 5);
	...
	StaticBoxSizer5->Add(FlexGridSizer15, 1, wxEXPAND, 0);
	FlexGridSizer12->Add(StaticBoxSizer5, 1, wxEXPAND, 5);
	FlexGridSizer11->Add(FlexGridSizer12, 1, wxEXPAND, 0);
	...
	FlexGridSizer1->Add(includeTextCtrl, 1, wxEXPAND, 5);
	StaticBoxSizer1->Add(FlexGridSizer1, 1, wxEXPAND, 0);
	FlexGridSizer10->Add(StaticBoxSizer1, 1, wxEXPAND, 5);
	...
	FlexGridSizer4->Add(codeEdit, 1, wxEXPAND, 5);
	...
	FlexGridSizer10->Add(FlexGridSizer4, 1, wxEXPAND, 0);
	FlexGridSizer9->Add(FlexGridSizer10, 1, wxEXPAND, 0);
	FlexGridSizer3->Add(FlexGridSizer9, 1, wxEXPAND, 0);
	FlexGridSizer2->Add(FlexGridSizer3, 1, wxEXPAND, 0);
	StaticLine1 = new wxStaticLine(this, ID_STATICLINE1, wxDefaultPosition, wxSize(10,-1), wxLI_HORIZONTAL, _T("ID_STATICLINE1"));
	FlexGridSizer2->Add(StaticLine1, 1, wxEXPAND, 0);
