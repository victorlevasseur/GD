	...
	feedbackWritten(false)
{
	...
	FlexGridSizer7->Add(StaticText4, 1, wxEXPAND, 5);
	...
	FlexGridSizer7->Add(feedbackEdit, 1, wxEXPAND, 5);
	...
	FlexGridSizer8->Add(mailEdit, 1, wxEXPAND, 5);
	...
	FlexGridSizer7->Add(StaticLine1, 1, wxEXPAND, 5);
	...
	FlexGridSizer6->Add(-1,-1,1, wxEXPAND, 0);
