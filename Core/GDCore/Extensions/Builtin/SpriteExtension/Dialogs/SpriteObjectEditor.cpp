    ...
    mainFrameWrapper(mainFrameWrapper_)
{
	...
	AuiManager1->Update();
	FlexGridSizer8->Add(toolbarPanel, 1, wxEXPAND, 0);
	...
	FlexGridSizer4->Add(imagePanel, 1, wxEXPAND, 0);
	...
	FlexGridSizer4->Add(yScrollBar, 0, wxEXPAND, 0);
	...
	FlexGridSizer4->Add(xScrollBar, 1, wxEXPAND, 0);
	...
	FlexGridSizer2->Add(animationsTree, 1, wxEXPAND, 0);
	...
	FlexGridSizer1->Add(imagesList, 1, wxEXPAND, 0);
	...
	AuiManager2->Update();
	FlexGridSizer5->Add(Panel1, 1, wxEXPAND, 0);
	...
	FlexGridSizer5->Add(pointsList, 1, wxEXPAND, 0);
